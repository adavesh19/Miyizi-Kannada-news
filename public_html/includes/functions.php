...
function auto_editor_pack(array $article): array
{
    ...
    // Dynamic, randomized template shuffling
    $introPool = [
        "{$title} ಎಂಬ ಸುದ್ದಿ {$source} ಮೂಲದಿಂದ ಪ್ರಕಟವಾಗಿದ್ದು, {$category} ವಲಯದಲ್ಲಿ ಭಾರಿ ಸಂಚಲನ ಮೂಡಿಸಿದೆ.",
        "ಇತ್ತೀಚಿನ ವರದಿಗಳ ಪ್ರಕಾರ, {$title} ಕುರಿತು ಪ್ರಮುಖ ಬೆಳವಣಿಗೆ ಕಂಡುಬಂದಿದೆ. {$source} ಮೂಲಗಳು ಈ ವಿಷಯವನ್ನು ಖಚಿತಪಡಿಸಿವೆ.",
        "{$category} ವಿಭಾಗದಲ್ಲಿ ಹೊಸದಾಗಿ ಕೇಳಿಬರುತ್ತಿರುವ ಈ ಸುದ್ದಿ ಎಲ್ಲೆಡೆ ವ್ಯಾಪಕ ಚರ್ಚೆಗೆ ಕಾರಣವಾಗಿದೆ. {$source} ನೀಡಿದ ವಿವರ ಇಲ್ಲಿದೆ.",
    ];
    
    $summaryPool = [
        (mb_strlen(normalize_space((string) $summary), 'UTF-8') > 50) 
            ? $summary 
            : "{$source} ಪ್ರಕಟಿಸಿದ ವಿವರಗಳ ಪ್ರಕಾರ, ಈ ಸುದ್ದಿ {$pubLabel} ಸಮಯದಲ್ಲಿ ಮುಂಚೂಣಿಗೆ ಬಂದಿದೆ. ಹಲವರು ಈ ಬಗ್ಗೆ ಗಂಭೀರ ಕಳಕಳಿ ವ್ಯಕ್ತಪಡಿಸಿದ್ದಾರೆ.",
    ...
    // Pick random details to make paragraph count dynamic
